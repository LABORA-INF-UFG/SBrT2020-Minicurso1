...
2. Preparing environment
    ...
    # setup network interfaces, namespaces and tunnels
...
3. Importing GoLand IDE workspace
    ...
    cd ~/my5G-core
    wget -q -0 https://raw.githubusercontent.com/LABORA-INF-UFG/SBrT2020-Minicurso1/master/media/workspace.xml
    mkdir .idea
...
1. Start network traffic sniffing
    ```bash
    wireshark -kni any --display-filter "isakmp or nas-5gs or ngap or pfcp or gtp or esp or gre or (http and ip.addr == 10.1.1.0/24)" &
    ```
